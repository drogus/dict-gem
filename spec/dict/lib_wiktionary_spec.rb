...
describe Dict::Wiktionary do
  ...
  it "should not fail when there is no textarea element" do
    VCR.use_cassette('wiktionary_translations_addled_cassette') do
    w = Dict::Wiktionary.new("addled").translate
    w.translations.should ==  {"addled"=>[]}
    end
  end
